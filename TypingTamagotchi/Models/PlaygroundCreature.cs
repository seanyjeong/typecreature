...
public partial class PlaygroundCreature : ObservableObject
{
    ...
    // 그림자 X 위치 (크리처 중앙 아래)
    public double ShadowX => X + 6; // 그림자 중앙 맞추기 (72px 크리처, 60px 그림자)

    // 그림자 Y 위치 (바닥 - 그림자 높이의 절반)
    public double ShadowY => GroundY - 8;
    ...
    {
        6, 19, 20, 22, 27, 29, 32, 33, 37, 38, 39, 40, 45, 46, 47, 48, 50, 52
    };
