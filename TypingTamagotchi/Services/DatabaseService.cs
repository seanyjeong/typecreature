...
public class DatabaseService
{
    ...
    public void SeedCreaturesIfEmpty()
    {
        ...
        // 50종 크리처 데이터 (name, rarity, desc, age, gender, food, dislikes, background)
        var creatures = new List<(string name, Rarity rarity, string desc, string age, string gender, string food, string dislikes, string background)>
        {
            // Common (25종) - ID 1~25
        ...
        insertCommand.CommandText = @"
            INSERT INTO creatures (name, rarity, sprite_path, description, age, gender, favorite_food, dislikes, background)
            VALUES (@name, @rarity, @sprite, @desc, @age, @gender, @food, @dislikes, @background)
        ";
